...
Le patch sono generate a partire dal tag upstream open-webui **v0.9.2** (commit `8dae237a0`).

```bash
# Applica tutte le patch su un branch da v0.9.2
git checkout -b my-branch v0.9.2
git am patches/*.patch
